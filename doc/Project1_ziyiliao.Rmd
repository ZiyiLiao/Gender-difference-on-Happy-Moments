...
```
Words that are close to the line in these plots have similar frequencies in both sets of texts, which means there is no such similarity between females' response and males' response
...
* Plot trajectory of each gender
```{r}
